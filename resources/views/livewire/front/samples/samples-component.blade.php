                    ...
                    <div class="col my-2">
                        <div class="ws-article-card d-flex flex-column h-100">
                            ...
                            <div class="ws-article-card-body">
                                <div class="ws-article-card-title  pt-3"><h5>{{ $sample->title_persian }}</h5></div>
                                ...
                                <div class="ws-article-card-footer d-flex justify-content-between my-1">
                                    <div class="py-2 px-2 ws-article-date"><i
                                            class="fa-regular fa-clock"></i>{{ jDate($sample->created_at)->ago()  }}
                                    </div>
                                    <a class="btn ws-article-continue" href="{{ route('sample', [$sample->slug]) }}">ادامه....</a>
                                </div>
                            </div>
                        </div>
                    </div>
